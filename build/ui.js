(() => {
  ...
  function z(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, y3, _3, m3, b2, S2, C3, M2, $3, I2, A4, H3, L2, T4 = u3.type;
    if (void 0 !== u3.constructor) return null;
    128 & t3.__u && (c3 = !!(32 & t3.__u), o3 = [f3 = u3.__e = t3.__e]), (a3 = l.__b) && a3(u3);
    n: if ("function" == typeof T4) try {
      if (S2 = u3.props, C3 = "prototype" in T4 && T4.prototype.render, M2 = (a3 = T4.contextType) && i3[a3.__c], $3 = a3 ? M2 ? M2.props.value : a3.__ : i3, t3.__c ? b2 = (h3 = u3.__c = t3.__c).__ = h3.__E : (C3 ? u3.__c = h3 = new T4(S2, $3) : (u3.__c = h3 = new x(S2, $3), h3.constructor = T4, h3.render = G), M2 && M2.sub(h3), h3.state || (h3.state = {}), h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), C3 && null == h3.__s && (h3.__s = h3.state), C3 && null != T4.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = w({}, h3.__s)), w(h3.__s, T4.getDerivedStateFromProps(S2, h3.__s))), y3 = h3.props, _3 = h3.state, h3.__v = u3, p3) C3 && null == T4.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), C3 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
      else {
        if (C3 && null == T4.getDerivedStateFromProps && S2 !== y3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(S2, $3), u3.__v == t3.__v || !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(S2, h3.__s, $3)) {
      ...
      if (h3.context = $3, h3.props = S2, h3.__P = n2, h3.__e = false, I2 = l.__r, A4 = 0, C3) h3.state = h3.__s, h3.__d = false, I2 && I2(u3), a3 = h3.render(h3.props, h3.state, h3.context), v.push.apply(h3.__h, h3._sb), h3._sb = [];
      else do {
  ...
  var init_inline = __esm({
    "node_modules/@create-figma-plugin/ui/lib/layout/inline/inline.js"() {
      ...
      Inline = createComponent(function(_a, ref) {
        ...
        return _("div", __spreadProps(__spreadValues({}, rest), { ref, class: typeof space === "undefined" ? void 0 : inline_module_default[space] }), L(children).map(function(child, index) {
  ...
  var init_stack = __esm({
    "node_modules/@create-figma-plugin/ui/lib/layout/stack/stack.js"() {
      ...
      Stack = createComponent(function(_a, ref) {
        var _b = _a, { children, space } = _b, rest = __objRest(_b, ["children", "space"]);
        return _("div", __spreadProps(__spreadValues({}, rest), { ref, class: stack_module_default[space] }), L(children).map(function(element, index) {
...
`;
  ...
  function render(Plugin) {
    return function(rootNode2, props) {
      J(_(Plugin, __spreadValues({}, props)), rootNode2);
    };
  }
  ...
  var init_lib2 = __esm({
    "node_modules/@create-figma-plugin/ui/lib/index.js"() {
      ...
      init_icon_spacing_horizontal_small_24();
  ...
  // src/app/tool-registry-icons-import.tsx
  var COMPONENTS, TOOL_ICONS;
  var init_tool_registry_icons_import = __esm({
    "src/app/tool-registry-icons-import.tsx"() {
      "use strict";
      init_lib2();
      init_preact_module();
      ...
      TOOL_ICONS = Object.fromEntries(
        Object.entries(COMPONENTS).map(([name, Comp]) => [name, _(Comp, null)])
      );
    }
  });
  ...
  var sectionTitleStyle, CATEGORY_ORDER;
  var init_HomeView = __esm({
    "src/app/views/home/HomeView.tsx"() {
      ...
      init_Page();
      init_ToolCard();
      init_tool_registry_icons_import();
      init_tools_registry();
  ...
  function ToolFooter(props) {
    return /* @__PURE__ */ _(
      ...
      L(props.children).map((child, i3) => /* @__PURE__ */ _("div", { key: i3, style: { display: "flex", width: "100%" } }, /* @__PURE__ */ _("div", { style: { flex: 1, minWidth: 0 } }, child)))
    );
  }
  ...
  function DataList(props) {
    var _a;
    const children = L(props.children).filter(Boolean);
