...
import { getToolById, isToolId, TOOLS_REGISTRY, type ActiveTool, type ToolId } from "../tools-registry/tools-registry"
...
import { registerLibrarySwapTool } from "../tools/migrate-to-islands-uikit-tool/main-thread"
import { registerPrintColorUsagesTool } from "../tools/print-color-usages-tool/main-thread"
import { registerVariablesExportImportTool } from "../tools/variables-export-import-tool/main-thread"
import { registerVariablesBatchRenameTool } from "../tools/variables-rename-tool/main-thread"
import { registerVariablesCreateLinkedColorsTool } from "../tools/variables-create-linked-colors-tool/main-thread"
import { registerVariablesReplaceUsagesTool } from "../tools/variables-replace-usages-tool/main-thread"
import { registerFindColorMatchTool } from "../tools/find-color-match-tool/main-thread"
import { registerAutomationsTool } from "../tools/automations-tool/main-thread"
