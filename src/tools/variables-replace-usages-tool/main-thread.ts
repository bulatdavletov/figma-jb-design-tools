...
import { getVariable, getCollection, getAllLocalVariables } from "../../utils/variables-shared/caching"
import {
  hasChildren,
  isNodeVisible,
  hasBoundVariables,
...
import { parseUsagesReplaceMappingJson, isString } from "../../utils/variables-shared/json-parsers"
import type {
  VariableUsage,
  VariableMatch,
  ColorUsage,
  UsagesReplaceMappingJsonDoc,
} from "../../utils/variables-shared/types"
